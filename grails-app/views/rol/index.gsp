		...
		<div id="list-rol" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="rol" title="${message(code: 'rol.rol.label', default: 'Rol')}" />
				...
				<g:each in="${rolInstanceList}" status="i" var="rolInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${rolInstance.id}">${fieldValue(bean: rolInstance, field: "rol")}</g:link></td>
