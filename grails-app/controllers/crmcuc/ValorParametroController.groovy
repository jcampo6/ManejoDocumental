...
class ValorParametroController {
    ...
    def index(Integer max) {
        ...
        def query="from ValorParametro v where v.parametros.id=${params.id}"
        
        def valorParametroInstanceList=ValorParametro.executeQuery(query)
        println "valorParametroInstanceList=${valorParametroInstanceList}"
        render view:"index", model:[valorParametroInstanceList:valorParametroInstanceList,
                       valorParametroInstanceCount: ValorParametro.count()]
    }
